// Taken from https://raw.githubusercontent.com/cran/tmg/master/src/HmcSampler.h
...
class HmcSampler {
 public:
  ...
  void addQuadraticConstraint(const MatrixXd &A, const VectorXd &B,
                              const double &C);
 ...
 private:
  ...
  void _getNextLinearHitTime(const VectorXd &a, const VectorXd &b, double &t,
                             int &cn);
  double _verifyConstraints(const VectorXd &);
  void _updateTrace(VectorXd const &a, VectorXd const &b, double const &tt,
