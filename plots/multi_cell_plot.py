...
LAMBDA_EXPONENTS = np.arange(-7.0, -1.0 + 0.01, 1.0)# 0.25)
...
fig.savefig(f"./plots/pdfs/multi_{TISSUE}_prolif_vs_lambda.pdf", bbox_inches='tight')
...
fig.savefig(f"./plots/pdfs/multi_{TISSUE}_prolif_vs_dosage.pdf", bbox_inches='tight')

fig, ax = plt.subplots(figsize=(3.9,2.99))
drug_usage_plot(ax, search_treatments)
fig.savefig(f"./plots/pdfs/multi_{TISSUE}_search_dosage.pdf", bbox_inches='tight')
